...
export const en = {
  ...
  home: {
    ...
    syncedSuccess: "Synced to Government Portal",
  ...
  // Learn Screen
  learn: {
    pageTitle: "Scam Defence Missions",
    pageSubtitle: "Train yourself to spot & defeat financial fraud",
    yourMissions: "YOUR MISSIONS",
    statusCompleted: "Completed",
    statusActive: "Active Threat",
    statusLocked: "Locked – complete Mission",
    fraudSafetyTips: "FRAUD SAFETY TIPS",
    tips: [
      {
        id: "t1",
  ...
  // Profile Screen
  profile: {
    defaultUserName: "BharatQuest User",
    trustScoreFormat: "Trust Score",
    creditFormat: "Credit",
    manageAccount: "MANAGE ACCOUNT",
    editProfile: "Edit Profile",
    editProfileSub: "Update your name and details",
    notifications: "Notifications",
    notificationsSub: "Manage alerts and reminders",
    changePin: "Change PIN / Password",
    changePinSub: "Keep your account secure",
    ...
    fontSize: "Font Size",
    fontSizeSub: "Adjust text size across the app",
    assistedModeSub: "Slower pace with extra guidance",
    languageSub: "Choose your preferred language",
    logout: "Log Out",
    logoutHint: "Logging out will reset your game progress for this demo session.",
  },
  // Demo Tools
  demo: {
    title: "Demo Tools",
    simulateSms: "Simulate Scam SMS",
